...
`/report-codex/` 为独立重建版本，按“每周学情预告、日学情反馈、主题月学情反馈、阶段学情反馈”展示四类家长触达。日报按“产品触达 / 班班触达”分别双图并排，阶段报告同时展示新版班班消息、封面与完整报告；日报、月报、阶段报均在固定高度窗口内纵向滚动。页首使用小尺寸叫叫标志旗，图片随首屏统一预加载，课程预告直接载入独立 HTML，插画弱化为右侧水印；静态截图统一使用 WebP。无 API、无用户数据采集。
